...
- **Leading indicators (process compliance)**: These tell you whether you are executing the habits. "Did I do the daily review? Did I pray on time? Did I catch my anger?" — process-focused.

- **Lagging indicators (domain outcomes)**: These tell you whether the domain itself is actually improving. They answer the deeper question — *"Is this domain actually improving — not just am I doing the habits, but is the trait itself shifting?"*
...
:::tip How to use these levels

1. Identify where you currently are for each bad trait (L1, L2, or L3).
2. Define your target level (typically L3, but L2 may be a realistic intermediate goal).
3. Apply the correct intervention for your current level — don't try behavior change protocols when you need hope injection first.
...
- **Dual-Threat**: Can take either path depending on your energy state. Common for: lust, gluttony.

The full framework for understanding and applying these paths is explained in the [Taqwa Framework](docs/sidebar1/Resources/Taqwa%20framework.md) article.
